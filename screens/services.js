...
export default class Services extends Component {
  ...
  <Text style={[styles.subtitle,{color:'#eb144c'}]}>Who we are</Text>

  <Text style={{fontWeight:'700',fontSize:35,color:'white',textAlign:'center'}}>About Digital Team</Text>
...
<Text style={[styles.subtitle,{color:'white',fontWeight:'500'}]}>You are shop-owners of physical stores with high-traffic consumers and think to go digital. Or you are online shop-owners with E-Commerce websites. Both of you want to maximize sale opportunities. MStore is powerful to increase customer experience through the mobile devices. Leading business knows how important its consumer experience is to increase sale.
  ...
  Explore Our Demo App and Themes
</Text>
<Button bordered light rounded style={{padding:25}} onPress={()=>{this.props.navigation.navigate('UI')}}>
    ...
    Feature () {
        return (
          ...
          <View style={{flex:1,justifyContent:'center',alignItems:'flex-start',padding:30,backgroundColor:'#fff'}}>
          <Text style={{fontWeight:'700',fontSize:20,color:'#000000'}}>We help new student at yarmouk university</Text>
<View style={{flexDirection:'row',justifyContent:'space-between'}}>
<Ionicons name="ios-checkmark" size={30} color="black" />

  <Text style={[styles.subtitle,{color:'#000000'}]}>#1 Help computer engineer student</Text>
  </View>
  <View style={{flexDirection:'row',justifyContent:'space-between'}}>
  <Ionicons name="ios-checkmark" size={30} color="black" />

    <Text style={[styles.subtitle,{color:'#000000'}]}>Answer all question for student</Text>
    </View>
    <View style={{flexDirection:'row',justifyContent:'space-between'}}>
    <Ionicons name="ios-checkmark" size={30} color="black" />

      <Text style={[styles.subtitle,{color:'#000000'}]}>Make event for fun and learn</Text>
      </View>
</View>
        );
    }
    why () {
        return (
          ...
          <Text style={{fontWeight:'700',fontSize:20,color:'#000000',alignSelf:'flex-start'}}>Professional Team who find solution for every problem</Text>
