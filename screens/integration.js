...
export default class Integration extends Component {
      ...
      const isTinder = type === 'tinder';
        return (
          <View style={[styles.exampleContainer, isTinder ? styles.exampleContainerDark : styles.exampleContainerLight]}>
                          <Text style={[styles.title, isTinder ? {} : styles.titleDark]}>Integration Method</Text>
                          <Text style={[styles.subtitle, isTinder ? {} : styles.titleDark]}>Explore the best platform for your website</Text>
                          <Carousel
                            data={isTinder ? ENTRIES2 : ENTRIES3}
  ...
  <Text style={[styles.subtitle,{color:'#eb144c'}]}>Website integration</Text>

  <Text style={{fontWeight:'700',fontSize:35,color:'white',textAlign:'center'}}>Ecommerce Website Solution</Text>
...
<Text style={[styles.subtitle,{color:'white',fontWeight:'500'}]}>You are shop-owners of physical stores with high-traffic consumers and think to go digital. Or you are online shop-owners with E-Commerce websites. Both of you want to maximize sale opportunities. MStore is powerful to increase customer experience through the mobile devices. Leading business knows how important its consumer experience is to increase sale.
  ...
  Explore Our Portfolio website
</Text>
<Button bordered light rounded style={{padding:25}}>
    ...
    Feature () {
        return (
          ...
          <Text style={{fontWeight:'700',fontSize:20,color:'#000000',marginVertical:10}}>Full integration with E-commerce website provider
</Text>
...
{example0}
                    ...
                    <Button full dark iconRight style={{paddingHorizontal:10}}>
                               <Text style={{color:'white',fontSize:17,marginHorizontal:10}}>Get Your Store Now</Text>
