...
<TouchableOpacity onPress={()=>{this.props.navigation.navigate('Onboarding',{title:'basic'})}}>
<Text style={{        backgroundColor: 'transparent',
        color: 'white',
        marginVertical:5,
        fontSize: 16,
...
<TouchableOpacity onPress={()=>{this.props.navigation.navigate('Onboarding',{title:'openshop'})}}>
<Text style={{        backgroundColor: 'transparent',
        color: 'white',
        marginVertical:5,
        fontSize: 16,
